...
export default function Home() {
  return (
    <section className="max-w-full gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      <Card
      ...
      >
        <Link href="https://letterboxd.com/f1shf1sh/">
          <div className="absolute inset-0 z-0">
            <Image
              removeWrapper
              src="/film.jpeg"
      ...
      <Card
        ...
        className="col-span-4 row-span-1 content-center sm:col-span-1 p-4" // Add custom styles via class names
      >
        <Link href="https://unsplash.com/@f1shf1sh">
          <div className="absolute inset-0 z-0">
            <Image
              // removeWrapper;
              src="/sikkim.JPG"
